...
TEST(a4io_netio, try_dynamic_rfio) {
    ...
    int    fd = calls.open(
        const_cast<char *>(tempfile.c_str()), O_CREAT, S_IRUSR | S_IWUSR);
...
TEST(a4io_netio, try_dynamic_dcache_io) {
    ...
    ASSERT_EQ(0, calls.last_errno());
    string testfile =
        "dcap://lcg-lrz-dcache.grid.lrz-muenchen.de:22125//pnfs/lrz-muenchen.de/data/atlas/dq2/atlaslocalgroupdisk/user/ebke/20120130180629/user.ebke.20120130180629.1352.t_50_53.5330.ANALY_RAL/user.ebke.048504.EXT0._01044.events.a4";
