...
bool InputStream::skip_to_next_metadata() {
    return _impl->
           skip_to_next_metadata();
}
size_t      InputStream::ByteCount() { return _impl->ByteCount(); }
std::string InputStream::str()       { return _impl->str(); }

const std::vector < std::vector <
shared<a4::io::A4Message >>> & InputStream::all_metadata() {
...
std::vector<const google::protobuf::FileDescriptor *> InputStream::
get_filedescriptors() {
    return _impl->get_filedescriptors();
}

bool InputStream::try_read(google::protobuf::Message          & msg,
